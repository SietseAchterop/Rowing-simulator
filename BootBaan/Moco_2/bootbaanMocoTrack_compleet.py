...
def muscleDrivenStateTracking():
    ...
    coordWeights.cloneAndAppend(osim.MocoWeight("/jointset/boatJoint/seatpos/value", 2))
    coordWeights.cloneAndAppend(osim.MocoWeight("/jointset/boatJoint/hipangle/value", 2))
    coordWeights.cloneAndAppend(osim.MocoWeight("/jointset/boatJoint/kneeangle/value", 2))
    coordWeights.cloneAndAppend(osim.MocoWeight("/jointset/boatJoint/footangle/value", 2))
    coordWeights.cloneAndAppend(osim.MocoWeight("/jointset/boatJoint/lbackangle/value", 2))
