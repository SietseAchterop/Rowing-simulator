...
# Moco does not support BallJoint

uarmltf = osim.SpatialTransform()
uarml_0 = osim.ArrayStr()
uarml_0.append("uarmleft_out")
uarmltf.updTransformAxis(0).setCoordinateNames(uarml_0)
uarmltf.updTransformAxis(0).set_function(osim.LinearFunction())
uarml_1 = osim.ArrayStr()
uarml_1.append("uarmleft_trn")
uarmltf.updTransformAxis(1).setCoordinateNames(uarml_1)
uarmltf.updTransformAxis(1).set_function(osim.LinearFunction())
uarml_2 = osim.ArrayStr()
uarml_2.append("uarmleft_up")
uarmltf.updTransformAxis(2).setCoordinateNames(uarml_2)
uarmltf.updTransformAxis(2).set_function(osim.LinearFunction())
...
hdlltf = osim.SpatialTransform()
hdll_0 = osim.ArrayStr()
hdll_0.append("handleleft_out")
hdlltf.updTransformAxis(0).setCoordinateNames(hdll_0)
hdlltf.updTransformAxis(0).set_function(osim.LinearFunction())
hdll_1 = osim.ArrayStr()
hdll_1.append("handleleft_trn")
hdlltf.updTransformAxis(1).setCoordinateNames(hdll_1)
hdlltf.updTransformAxis(1).set_function(osim.LinearFunction())
hdll_2 = osim.ArrayStr()
hdll_2.append("handleleft_up")
hdlltf.updTransformAxis(2).setCoordinateNames(hdll_2)
hdlltf.updTransformAxis(2).set_function(osim.LinearFunction())


handlelJoint = osim.CustomJoint("handle_left_Joint",
                                soar,
...
uarmrtf = osim.SpatialTransform()
uarmr_0 = osim.ArrayStr()
uarmr_0.append("uarmright_out")
uarmrtf.updTransformAxis(0).setCoordinateNames(uarmr_0)
uarmrtf.updTransformAxis(0).set_function(osim.LinearFunction())
uarmr_1 = osim.ArrayStr()
uarmr_1.append("uarmright_trn")
uarmrtf.updTransformAxis(1).setCoordinateNames(uarmr_1)
uarmrtf.updTransformAxis(1).set_function(osim.LinearFunction())
uarmr_2 = osim.ArrayStr()
uarmr_2.append("uarmright_up")
uarmrtf.updTransformAxis(2).setCoordinateNames(uarmr_2)
uarmrtf.updTransformAxis(2).set_function(osim.LinearFunction())
...
hdlrtf = osim.SpatialTransform()
hdlr_0 = osim.ArrayStr()
hdlr_0.append("handleright_out")
hdlrtf.updTransformAxis(0).setCoordinateNames(hdlr_0)
hdlrtf.updTransformAxis(0).set_function(osim.LinearFunction())
hdlr_1 = osim.ArrayStr()
hdlr_1.append("handleright_trn")
hdlrtf.updTransformAxis(1).setCoordinateNames(hdlr_1)
hdlrtf.updTransformAxis(1).set_function(osim.LinearFunction())
hdlr_2 = osim.ArrayStr()
hdlr_2.append("handleright_up")
hdlrtf.updTransformAxis(2).setCoordinateNames(hdlr_2)
hdlrtf.updTransformAxis(2).set_function(osim.LinearFunction())

handlerJoint = osim.CustomJoint("handle_right_Joint",
                              poar,
                              osim.Vec3(0, (inbhand+outboard)/2, 0),
                              osim.Vec3(-pi/2, 0, 0),
                              lowerar_l,
