...
class BladeForceImpl : public ForceImpl {
public:
    class Parameters;
    BladeForceImpl(GeneralContactSubsystem& subsystem, 
                               ContactSetIndex set);
    BladeForceImpl* clone() const override {
        return new BladeForceImpl(*this);
    }
...
class BladeForceImpl::Parameters {
public:
