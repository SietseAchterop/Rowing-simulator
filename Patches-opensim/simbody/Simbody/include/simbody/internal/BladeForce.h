 ...
 * <li>Add an BladeForce to the GeneralForceSubsystem, and call setBodyParameters() on it
 ...
 */
class SimTK_SIMBODY_EXPORT BladeForce : public Force {
public:
    /**
     * Create an elastic foundation contact model.
     * 
     * @param forces         the subsystem which will own this BladeForce element
     ...
     */
    BladeForce(GeneralForceSubsystem& forces, GeneralContactSubsystem& contacts, ContactSetIndex contactSet);
    /**
    ...
    SimTK_INSERT_DERIVED_HANDLE_DECLARATIONS(BladeForce, BladeForceImpl, Force);
};
