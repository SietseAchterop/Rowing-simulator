...
class OSIMSIMULATION_API BladeForce : public Force {
OpenSim_DECLARE_CONCRETE_OBJECT(BladeForce, Force);
public:
...
//==============================================================================
    BladeForce();
    explicit BladeForce(ContactParameters* params);
...
class OSIMSIMULATION_API BladeForce::ContactParameters 
:   public Object {
OpenSim_DECLARE_CONCRETE_OBJECT(BladeForce::ContactParameters, 
                                Object);
public:
//==============================================================================
// PROPERTIES
...
class OSIMSIMULATION_API BladeForce::ContactParametersSet 
:   public Set<BladeForce::ContactParameters> {
OpenSim_DECLARE_CONCRETE_OBJECT(BladeForce::ContactParametersSet, 
                                Set<BladeForce::ContactParameters>);
